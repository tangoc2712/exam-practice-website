  ...
  return (
    <div 
      className={classNames(
        'bg-[#1A1A2E]/80 backdrop-blur-md border border-[#333344] rounded-lg p-6 md:p-8 transition-all duration-300',
...
export const GlassPanel: React.FC<HTMLAttributes<HTMLDivElement>> = ({ children, className, ...props }) => {
  return (
    <div className={classNames('bg-[#1A1A2E] border border-[#333344] rounded-lg shadow-2xl p-6 md:p-10 relative overflow-hidden', className)} {...props}>
